...
<title>Tambah Produk — CampusMarket</title>
...
<div class="min-h-screen">
    ...
    <div class="ml-60 p-8">
        ...
        <div class="max-w-2xl">
            ...
            <p class="text-gray-600 mb-8">Isi formulir berikut untuk menambahkan produk ke toko Anda</p>
            ...
            <form action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm p-8 space-y-6">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
                        ...
                        <div class="text-center pointer-events-none">
                            ...
                            <p class="mt-2 text-sm font-medium text-gray-700">Klik untuk upload atau drag & drop</p>
